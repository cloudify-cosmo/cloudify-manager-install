...
POSTGRES_CERT_FILENAME = 'cloudify_postgres_cert.pem'
POSTGRES_KEY_FILENAME = 'cloudify_postgres_key.pem'
...
POSTGRES_CERT_PATH = join(SSL_CERTS_TARGET_DIR, POSTGRES_CERT_FILENAME)
POSTGRES_KEY_PATH = join(SSL_CERTS_TARGET_DIR, POSTGRES_KEY_FILENAME)
