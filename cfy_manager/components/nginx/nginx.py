...
class Nginx(BaseComponent):
    ...
    def _needs_to_replace_internal_certs():
        return (os.path.exists(constants.NEW_INTERNAL_CERT_FILE_PATH) or
                os.path.exists(constants.NEW_INTERNAL_CA_CERT_FILE_PATH))

    @staticmethod
    def _needs_to_replace_external_certs():
        return (os.path.exists(constants.NEW_EXTERNAL_CERT_FILE_PATH) or
                os.path.exists(constants.NEW_EXTERNAL_CA_CERT_FILE_PATH))
    ...
    def _write_internal_certs_to_config():
        if os.path.exists(constants.NEW_INTERNAL_CERT_FILE_PATH):
    ...
    def _write_external_certs_to_config():
        if os.path.exists(constants.NEW_EXTERNAL_CERT_FILE_PATH):
        ...
        if os.path.exists(constants.NEW_EXTERNAL_CA_CERT_FILE_PATH):
